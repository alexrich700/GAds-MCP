...
2. If the user asks specifically about creative quality: present the asset groups sorted by `ad_strength`, then drill into LOW-labeled assets via the `low_performing_assets` arrays.
